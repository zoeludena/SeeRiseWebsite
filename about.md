...
- Created the [SeeRise website](https://zoeludena.github.io/SeeRiseWebsite/).  
  - Created Figures (and content), Team (Zoe and Duncan's profiles), and App pages (embedded application).  
- Created the [SeeRise application](https://seerise-floridaapp.streamlit.app/).  
...
- Created first draft of the poster.  
  ...
  - Organized content.  
- Input datasets for Random Forest emulator for sea level rise for the [SeeRise application](https://seerise-floridaapp.streamlit.app/).  
- Added personal bio to the [SeeRise website](https://zoeludena.github.io/SeeRiseWebsite/).  
- Edited and wrote Q2 Report.  
...
- Added personal bio to the [SeeRise website](https://zoeludena.github.io/SeeRiseWebsite/).  
- Input datasets for Pattern Scaling emulator for sea level rise for the [SeeRise application](https://seerise-floridaapp.streamlit.app/).  
